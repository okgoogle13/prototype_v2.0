...
export function Card({ children, className = "", hoverEffect = false }: Props) {
  return (
    <motion.div
      ...
      className={`p-8 bg-[var(--sys-color-charcoalBackground-steps-1)] border-2 border-[var(--sys-color-concreteGrey-steps-0)] shadow-[var(--sys-shadow-elevation2Placard)] relative overflow-hidden ${className}`}

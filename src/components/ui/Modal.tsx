      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="absolute inset-0 bg-[var(--sys-color-charcoalBackground-base)]/80 backdrop-blur-sm"
          />
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-[var(--sys-color-charcoalBackground-steps-1)] border-2 border-[var(--sys-color-concreteGrey-steps-0)] shadow-[var(--sys-shadow-elevation4Float)] p-8"
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8 border-b-2 border-[var(--sys-color-concreteGrey-steps-0)] pb-4">

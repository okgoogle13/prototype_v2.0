    ...
    <header style={{ borderBottomColor: 'var(--sys-color-concreteGrey-steps-0)', borderBottomWidth: 1, borderBottomStyle: 'solid', background: 'color-mix(in srgb, var(--sys-color-charcoalBackground-base) 80%, transparent)' }} className="p-4 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3">
            <DocumentTextIcon className="w-8 h-8 text-[var(--sys-color-inkGold-base)]" />
                ...
                <div className="flex items-center gap-3">
                    ...
                    {photoURL && (
                        <button 
                          ...
                          title="View Profile"
                        >
                          <img src={photoURL} alt="Profile" style={{ borderRadius: 'var(--sys-shape-blockRiot02)', borderColor: 'color-mix(in srgb, var(--sys-color-inkGold-base) 40%, transparent)', borderWidth: 1, borderStyle: 'solid' }} className="w-8 h-8 shadow-sm" />
                        </button>
                    )}
                    <button 
                        onClick={onLogout}
                        ...
                        className="text-xs text-[var(--sys-color-worker-ash-base)] hover:text-[var(--sys-color-solidarityRed-base)] transition-colors px-2 py-1"
                    >
                        Logout
                    </button>
                </div>
